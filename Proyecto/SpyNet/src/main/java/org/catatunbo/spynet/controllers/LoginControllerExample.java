...
public class LoginController {
    ...
    private void navigateToDashboard(String role, String username) throws Exception {
        ...
        switch (role.toLowerCase()) {
            case "admin":
                dashboardFile = "dashboard-admin";
                break;
            case "auditor":
                dashboardFile = "dashboard-auditor";
                break;
            case "inspector":
                dashboardFile = "dashboard-inspector";
                break;
            case "cliente":
                dashboardFile = "dashboard-cliente";
                break;
            default:
                dashboardFile = "dashboard-cliente"; // Default fallback
                break;
        }
        ...
        // Nota: En una implementación más completa, aquí pasarías la información del usuario
        // al nuevo controlador usando un método como setUserInfo()
    }
