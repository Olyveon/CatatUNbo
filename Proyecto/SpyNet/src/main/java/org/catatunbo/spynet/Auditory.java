...
public class Auditory {
    ...
    public LocalDateTime getAuditoryDateLimit() { return auditoryDateLimit; }
    public void setAuditoryDateLimit(LocalDateTime auditoryDateLimit) { this.auditoryDateLimit = auditoryDateLimit; }

    public LocalDateTime getAuditoryDateEnd() { return auditoryDateEnd; }
